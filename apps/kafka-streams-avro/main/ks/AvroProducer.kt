...
import no.tordly.avro.aap.ErMedlem
import no.tordly.avro.aap.Medlem
import no.tordly.avro.aap.Response
...
fun main() {
    embeddedServer(Netty, port = 8081) {
        ...
        val soknader = createProducer<Soknad>("søknad-consumer")
        ...
        launch {
            while (isActive) {
                ...
                soknader.produce("soknad.avro", personident) {
                    Soknad(personident, arbeidetUtenlands)
                }
